...
<template>
  <form>
        ...
        <tr>
          ...
          <td>
            <input
              ...
              placeholder="点击选择文件"
              v-model="schematic.uploadFileName"
              readonly
            />
            <input
              ref="fileInputRef"
        ...
        <tr>
          ...
          <td>
            <select v-model="schematic.type">
              <option :key="item.data" :value="item.data" v-for="item in schematicTypes">{{ item.label }}</option>
            </select>
          </td>
        </tr>
        <tr>
    ...
    <div class="buttons">
      <MCButton v-if="props.mode === 'update'" :length="'medium'" @click="deleteSchematic"
        ><span style="color: red">删除</span></MCButton
      >
