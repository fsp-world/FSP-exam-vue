...
export const setUserBackground = (bgUrl: string) => request.post('/user/profile/setBackground', { bg_url: bgUrl });
export const setUsername = (newUsername: string) => request.post('/user/profile/setUsername', { newUsername });
